// pages/DirectEmailPage.js
const BasePage = require('./BasePage');

class DirectEmailPage extends BasePage {
  constructor(page) {
    super(page);

    this.jobDescriptionBox = page.locator('textarea').first();
    this.generateButton = page.locator('button:has-text("Generate Email")');
...
module.exports = DirectEmailPage;